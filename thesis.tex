...
\input{chapters/problem} \clearpage % Problem Formulation

\input{chapters/mi_ucb} \clearpage % MI-UCB

\input{chapters/plume} \clearpage % Plume stuff

\input{chapters/stl} \clearpage % RSTL stuff

\input{chapters/extension} \clearpage % Prior stuff

\input{chapters/conclusion} \clearpage % Conclusion
...
% DISR workshop paper
\input{chapters/disr.tex} \clearpage % DISR workshop paper

% BOM technical report
\input{chapters/incompressible.tex} \clearpage % Flow field stuff
...
\bibliography{library_stripped} % The references (bibliography) information are stored in the file named "Bibliography.bib"
