\lhead{\emph{Acronyms \& Abbreviations}} % Set the left side page header to "Abbreviations"
%
\listofsymbols{p{1.2in} p{4.5in}} % Include a list of Abbreviations (a table of two columns)
{
